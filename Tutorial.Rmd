...
Second, load the necessary modules for the following codes:
...
>"SliceOrder" (multi-band)

### Compute values yoursefl
...
python mriqc_tmux [main directory] [bids directory] [deriv directory] [temp directory] [subject] [processessors]
```
...
python fmriprep_tmux.py [main directory] [bids directory] [deriv directory] [temp directory] [subject] [processessors] [use aroma]
```
